...
namespace Microsoft.AzureCat.Samples.ObserverPattern.Interfaces
{
    ...
    public interface IClientObservableActor : IEntityIdActor
    {
        /// <summary>
        ...
        Task RegisterObservableActorAsync(string topic);
        ...
        /// <returns>The asynchronous result of the operation.</returns>
        Task UnregisterObservableActorAsync(string topic, bool useObserverAsProxy);
